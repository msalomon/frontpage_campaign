...
$campaign_donate_thankyou=elgg_echo('frontpage_campaign:settings:donation_thankyou');
if (strtolower($campaign_donate) == strtolower(elgg_echo('frontpage_campaign:settings:yes'))) {
	if ($campaign_donate_thankyou) {
		$body .= "<div class='elgg-col elgg-col-1of1' style='margin:10px 0px 0px 0px'>" .$campaign_donate_thankyou . "</div><div class='donationWrapper'>";
	}
