...
// edited also /forms/videolist/edit to unset the two custom variables
if(elgg_is_admin_logged_in() && elgg_get_plugin_setting('campaign_admin_id', 'frontpage_campaign') == elgg_get_page_owner_guid()){
	$content .=	"<br><div style = 'color:red'>" . elgg_echo('frontpage_campaign:settings:visible') . "<br></div>";
}
