...
$english = array(
		'frontpage_campaign:messages:no_files' => "No Files like this.",
		...
		'frontpage_campaign:copyright' => 'If not explicit mentioned, the listed pictures are free for your use with no conditions and software is open source (GNU General Public License (GPL), Version 2)',
		...
		'frontpage_campaign:settings:recource_text_label' => 'Show on top of the recources (e. g. for copyright description) ',
        'frontpage_campaign:settings:recources_label' => 'Show recources',
		'frontpage_campaign:recources_nocategory' => 'Miscellaneous',
